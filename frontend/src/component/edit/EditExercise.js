...
export default class EditExercise extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            weight: "", bodyType: "", duration: "",
            id: "", error: "", user: "",
            userData: [], data: exerciseData
        }
    ...
    submit = (e) => {
        ...
        e.preventDefault()
        const { first_name, last_name, weight, bodyType, duration, user } = this.state;
        const exercise = { first_name, last_name, weight, bodyType, duration, user }
